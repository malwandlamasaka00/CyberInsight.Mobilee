...
const RecentScanCard = ({ scans }) => {
  ...
  const getStatusBadge = (scan) => {
    if (scan.score >= 80) {
      return <span className="badge badge-secure">Secure</span>;
    }
    if (scan.score >= 50) {
      return <span className="badge badge-moderate">Needs Improvement</span>;
    }
            ...
            <div className="scan-modal-body">
              ...
              <div className="scan-modal-checks">
                ...
                <div className="scan-modal-checks-grid">
                  <div className="scan-modal-check-item passed">
                    <span>SSL/TLS</span>
                  ...
                  <div className="scan-modal-check-item warning">
